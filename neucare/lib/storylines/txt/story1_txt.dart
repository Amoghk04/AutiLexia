...
const String story1Question1Correct =
    "Awesome that’s correct! People with ASD(Autism spectrum disorder) generally do not like to engage in a lot of noisy environments and feel very insecure.";

const String story1Question1Wrong =
    "Not quite! You may be curious to know that people with ASD(Autism spectrum disorder) generally do not like to engage in a lot of noisy environments and feel very insecure.";

const List<String> story1Options1 = [
...
const String story1Question2Correct =
    "Great job! People with ASD are generally associated with the Savant’s syndrome enabling them to have a photographic memory. They are usually very confident with their answers and are creative and brilliant!";

const String story1Question2Wrong =
    "Not quite! People with ASD are generally associated with Savant’s syndrome enabling them to have photographic memory."
    "They usually are very confident with their answers and are creative and brilliant!";

const List<String> story1Options2 = [
  "1. He must’ve been scared unable to answer",
  "2. He must’ve answered correctly.",
...
const String story1Question3Correct =
    "That’s amazing you’re on a roll. People with ASD are extremely organised. They notice the slightest imperfections and correct it to the best of their ability!";
const String story1Question3Wrong =
    "Not quite! People with ASD are extremely organised. They notice the slightest imperfections and correct it to the best of their ability!";

const List<String> story1Options3 = [
  "1. In an organised manner.",
  "2. In a disorganised manner.",
  "3. Would’ve got confused or forgotten to collect the chillies.",
  "4. Would tell his parents that he won’t do it.",
];

const List<String> story1Question4 = [
  "Henry had a brother so close to him who passed away the previous year!. There was a golden ring that his brother gave him. ",
  "What do you think must have happened to that ring?"
];

const String story1Question4Correct =
    "Amazing job! People with ASD when subjected to a sad event like losing a loved one remember them through some comfort objects like the ring in Henry’s case.";

const String story1Question4Wrong =
    "Not quite! People with ASD when subjected to a sad event like losing a loved one remember them through some comfort objects like the ring in Henry’s case.";

const List<String> story1Options4 = [
  "1. Henry still has it with him all the time wherever he goes.",
