...
class FirstStoryLine extends HookWidget {
  ...
  const FirstStoryLine({super.key, required this.username});
  ...
  Widget build(BuildContext context) {
    return baseWidget(context, "First Story Line", _body(context), username);
  }
                            ...
                            MongoDBAuth()
                              ...
                              if (username != null) {
                                MongoDBAuth()
                                  ...
                                  MongoDBAuth()
                                      .updateUserTokens(username!, tokens + inc * multiplier)
                                      .then((_) {
